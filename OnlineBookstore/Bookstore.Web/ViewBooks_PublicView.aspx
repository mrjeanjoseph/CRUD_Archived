<%@ Page Title="View Books - Public View" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewBooks_PublicView.aspx.cs" Inherits="Bookstore.Web.ViewBooks_PublicView" %>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <asp:Panel class="alert alert-success" role ="alert" ID="Panel1" runat="server">
                ...
                <div class="card">
                    <div = class="card-body">
                        <div class="row">
                                ...
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="BookId" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="inventoryDetailGV_SelectedIndexChanged">
                                    <Columns>
